...
export class FormDadosPessoaisComponent implements OnInit {
  ...
  configurarFormulario() {
    this.dadosPessoaisForm = this.formBuilder.group({
      ...
      inputRg: [ null, [Validators.required]],
      inputOrgaoEmissor: [ null, [Validators.required, Validators.minLength(6)]],
      inputCpf: [ null, [Validators.required, Validators.minLength(11)]],
